...
first_key = next(iter(data_2021))
first_value = data_2021[first_key]
...
for main_dict in data_2021.values():
...
with open('lineitem_data/unique_pairs.json', 'w', encoding='utf-8') as file:
